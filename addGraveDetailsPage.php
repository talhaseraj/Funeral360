...
-->
    ...
    float: left;"><center><form action="addGraveDetails.php" method="post">
                    <h3>Grave Details</h3>
                    <a>Kin Name : </a>
                    <div ><input id="kinname" name="kinname" type="text" required/></div>
                    <div ><input id="sr" name="sr" type="hidden" value="<?php echo $_GET['del'];?>" required/></div>
                    <a>Kin Contact :</a>
                    <div ><input id="kincontact" name="kincontact" type="text" required/></div>
                    <a>Graveyard/Address :</a>
                    <div ><input id="graveyard" name="graveyard" type="text" required/></div>
                    
                    <a>MAP LOCATION :</a>
                    <div ><input id="lat" name="gravelat" type="text" readonly/></div>
                    <div ><input id="lng" name="gravelng"  type="text" readonly/></div>
