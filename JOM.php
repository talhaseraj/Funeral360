...
-->
    ...
    float: left;"><center><form action="regFuneral.php" method="post">
                    <h3>Funeral Detail</h3>
                    <a>Name : </a>
                    <div ><input id="name" name="name" type="text" required/></div>
                    <a>Father Name :</a>
                    <div ><input id="fathername" name="fathername" type="text" required/></div>
                    <a>Age :</a>
                    <div ><input id="age" name="age" type="text" required/></div>
                    <a>Cause Of Death :</a>
                    <div >
                        <input list="cod" name="cod" >
                    ...
                    <div ><input id="dat" name="dat" type="datetime-local" required/></div>
                    <a>Focal Person Contact :</a>
                    <div ><input id="fpc" name="fpc" type="text" required/></div>
                    <a>Address :</a>
                    <div ><input id="address" name="address" type="text" required/></div>
                    <a>MAP LOCATION :</a>
                    <div ><input id="lat" name="lat" type="text" readonly/></div>
                    <div ><input id="lng" name="lng"  type="text" readonly/></div>
