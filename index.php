...
include("addMarkers.php");
include("latestUpdates.php");
?> 
<html lang="en">
                ...
                <div class="nav-links animate__animated animate__fadeInDownBig">
                    <ul>
                        ...
                        <li class="nav-link" style="--i: 1.1s">
                            <a href="statisticsPage.php">Statistics</a>    
                        </li>
...
-->
    ...
    <main>
        <section>
            <marquee><img src="new.png" width="25px"> <b> Name : </b><?php echo $upd['name']; ?><b> Father Name : </b><?php echo $upd['fathername']; ?><b> address : </b><?php echo $upd['address']; ?> <b> Cause Of Death : </b><?php echo $upd['cod']; ?></marquee>
            <div class="banner" >
            <div id="googleMap" class="animate__animated animate__fadeInUpBig" style="width:100%;height:512px;"></div>
        ...
        <script>
            ...
            function myMap() {
                ...
                addMarker({
                    coords :{lat:<?php echo $row['lat'];?>,lng:<?php echo $row['lng'];?>},
                    content:'<h1>Personal Details :</h1><br><b>Name</b> :<?php echo $row['name'];?><b>  Father Name</b> :<?php echo $row['fathername'];?><br> <b>Cause of Death </b>:<?php echo $row['cod'];?><br><b> Age </b>: <?php echo $row['age'];?><br><h1>Funeral Details : </h1><br><b>Time And Date :<?php echo $row['dat'];?></b><br><b>Address :</b><?php echo $row['address'];?><br><b>For Details Contact :</b><?php echo $row['fpc'];?>'      
                          });
                	<?php } ?>
