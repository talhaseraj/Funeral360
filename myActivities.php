    ...
    <main>
	   ...
	   <?php while ($row = mysqli_fetch_array($results)) { ?>
		  <tr>
                 ...
                 <td>
                     <a href="editActivity.php?edit=<?php echo $row['sr']; ?>" class="edit_btn" >Edit Funeral Details</a>
			     </td>
			     <td>
              ...
              <?php
                    if($row['graveyard']=="")
                    {
				      echo "<a href='addGraveDetailsPage.php?del= $row[sr]' class='edit_btn'>Add Grave details</a>";
                    }
                    else
                    {
                      echo "<a href='editGraveDetailsPage.php?edit= $row[sr]' class='edit_btn'>Edit Grave details</a>";                                        
                    }
              ?>
              
              </td>
              <td>
				    <a href="deleteActivity.php?del=<?php echo $row['sr']; ?>" class="del_btn">Delete</a>
              </td>
		</tr>
	<?php } ?>
</table>
